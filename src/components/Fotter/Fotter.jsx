  ...
  return (
    <>
      <div className="  bg-[#2E3532]  ">
        <div className="container mx-auto py-10 px-4 flex flex-col md:flex-row justify-between ">
        ...
        <div>
          ...
          <div className=" flex gap-3">
            <input type="text" className="p-2 outline-none ring-1 ring-amber-600  rounded-md text-base"  />
            <button className="px-2 py-2 bg-amber-400 rounded-md font-semibold">Subsrcibe</button>
          </div>
